...
<!-- Mirrored from makaanlelo.com/tf_products_007/kripton/xhtml/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jul 2022 17:29:37 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="auth-form">
                                    ...
                                    <form id="register">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" class="form-control" placeholder="ana-silver22" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="phone" class="form-control" placeholder="+9185845834" required>
                                        </div>
                                        <!-- <div class="alert alert-warning" role="alert">
                                            <h5>you get 15% bonus on <b>Gold </b>, 15% bonus on<b>Silver </b>, 5% on <b>Bronze </b> for every deposit</h5>
                                            <h6>
                                                <b>Gold </b> Deposit($5000 - infinity)<br>
                                                <b>Silver </b> Minimum Deposit($5000 - $5000)<br>
                                                <b>Bronze </b> Minimum Deposit($50 - $500)<br>
                                            </h6>
                                        </div> -->
                                        <div class="form-group">
                                            <label class="mb-1"><strong>Account Type</strong></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="referral_id" class="form-control" placeholder="">
                                        </div>
                                        <div class="form-group">
    ...
    $.ajax({
        ...
        success: function (data) {
            if(data.trim() == 'successful'){
                ...
                Swal.fire({
                icon:'success',					
                html:'<div class=""> Registration Succsessful</div>',
                showConfirmButton:true,
                allowOutsideClick:false
                }).then((result) => {
                    location.href="index.php";	// location.href="";

                })
                }
                else if(data.trim() == 'email_exist'){
                Swal.fire({
                icon:'warning',					
                html:'<div class="">Email Already Exist</div>',
                showConfirmButton:true,
                allowOutsideClick:false
                })
                }
                else if(data.trim() == 'username_exist'){
                Swal.fire({
                icon:'warning',					
                html:'<div class="">Username Already Taken</div>',
                showConfirmButton:true,
                allowOutsideClick:false
                })
                }
