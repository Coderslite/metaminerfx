...
if ($numUser==1){
    ...
    if($query){
        $queryBonus = "INSERT INTO deposit(amount,type,email,transaction_id,method,status,date)VALUES(20,'investment_bonus','$email','$transaction_id','bitcoin','confirmed','$date')";
