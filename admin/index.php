...
<?php
    ...
    $fetchDeposit = mysqli_query($con, "SELECT * FROM deposit WHERE status = 'confirmed' ");
    $amount = 0;
    if (mysqli_num_rows($fetchDeposit) > 0) {
        while ($userrow = mysqli_fetch_assoc($fetchDeposit)) {
            $amount = $amount + $userrow['amount'];
        }
    }
    
                        $fetchUsersCount = mysqli_query($con, "SELECT * FROM users WHERE role = 'user'");
                        $RegisteredUsers = mysqli_num_rows($fetchUsersCount);

                        $fetchDepositCount = mysqli_query($con, "SELECT * FROM deposit WHERE status = 'confirmed'");
                        $depositCount = mysqli_num_rows($fetchDepositCount);

                        $fetchWithdrawCount = mysqli_query($con, "SELECT * FROM withdraw WHERE status = 'confirmed'");
                        $withdrawCount = mysqli_num_rows($fetchWithdrawCount);
				...
				<div class="row">
					<div class="col-xl-3 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header align-items-start border-0 pb-0">
								<div class="me-auto">
									<p class="mb-2 fs-13"><i class="fa fa-caret-up scale5 me-2 text-success" aria-hidden="true"></i>Available Balance</p>
									<h2 class="text-black mb-0 font-w600" >$<span id="amount2">10</span></h2>
                    ...
                    <div class="col-xl-3 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header align-items-start border-0 pb-0">
								<div class="me-auto">
									<a href="registered_users.php"><p class="mb-2 fs-13"><i class="fa fa-caret-up scale5 me-2 text-success" aria-hidden="true"></i>Registered Users</p></a>
									<h2 class="text-black mb-0 font-w600"><?php echo $RegisteredUsers?></h2>
								</div>
								<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header align-items-start border-0 pb-0">
								<div class="me-auto">
									<p class="mb-2 fs-13"><i class="fa fa-caret-down scale5 me-2 text-danger" aria-hidden="true"></i>Total Deposit</p>
									<h2 class="text-black mb-0 font-w600"><?php echo $depositCount?></h2>
								</div>
								<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3 col-sm-6">
						<div class="card overflow-hidden">
							<div class="card-header align-items-start border-0 pb-0">
								<div class="me-auto">
									<p class="mb-2 fs-13"><i class="fa fa-caret-down scale5 me-2 text-danger" aria-hidden="true"></i>Total Withdrawal</p>
									<h2 class="text-black mb-0 font-w600"><?php echo $depositCount?></h2>
								</div>
								<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
	$(document).ready(function(){
        ...
        const b = parseFloat(num).toLocaleString('en')
        $('#amount2').html(b);
	})
</script>
...
<!-- <script>
    document.getElementById("amount").onload = function() {myFunction()};
    function myFunction(){
        alert ("alert")
    }
</script> -->
