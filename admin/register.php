                                ...
                                <div class="auth-form">
                                    ...
                                    <form id="register">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" class="form-control" placeholder="ana-silver22">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="phone" class="form-control" placeholder="+9185845834">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="mb-1"><strong>Create Password</strong></label>
